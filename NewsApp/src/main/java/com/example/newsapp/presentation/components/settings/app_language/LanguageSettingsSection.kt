...
/**
 * Секция выбора языка интерфейса приложения.
 *
 * @param items - список доступных языков
 * @param currentLanguage - текущий язык (код)
 * @param setLanguage - функция для установки нового языка
 */
@Composable
fun LanguageSettingSection(
    items: List<SettingsItem.LanguageSetting>,
